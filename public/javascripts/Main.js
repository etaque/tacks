...
Elm.RouteParser.make = function (_elm) {
   ...
   var string = P(A2($Combine$Infix._op["<$>"],
   $String.fromList,
...
Elm.Page.Register.Model.make = function (_elm) {
   ...
   var Submit = function (a) {    return {ctor: "Submit",_0: a};};
   var FormAction = function (a) {
      return {ctor: "FormAction",_0: a};
   };
   var handleFormat = $Regex.regex("^\\w{3,20}$");
   var NewPlayer = F3(function (a,b,c) {
      return {handle: a,email: b,password: c};
   });
   var validation = A4($Form$Validate.form3,
   NewPlayer,
   ...
   function (s) {
      return A2($Form$Validate.format,s,handleFormat);
   })),
...
Elm.Update.make = function (_elm) {
   ...
   var mountRoute = F3(function (prevRoute,newRoute,_p6) {
      ...
      {case "Home": return A2(applyHome,
         ...
         case "EmptyRoute": return A2($Response.res,
           appState,
           $Effects.none);
         default: return A2($Response.res,appState,$Effects.none);}
   });
   ...
   var update = F2(function (appAction,_p13) {
      ...
      var _p15 = appAction;
      switch (_p15.ctor)
      {case "RouterAction": return A3($TransitRouter.update,
           routerConfig,
           _p15._0,
           _p21);
...
Elm.View.Utils.make = function (_elm) {
   ...
   var errMsg = function (e) {
      var _p0 = e;
      switch (_p0.ctor)
      {case "InvalidString": return "Required";
         ...
         case "InvalidInt": return "Invalid integer format";
         case "InvalidFloat": return "Invalid floating number format";
         case "ShorterStringThan": return A2($Basics._op["++"],
           "At least ",
           A2($Basics._op["++"],$Basics.toString(_p0._0)," chars"));
         default: return $Basics.toString(e);}
   };
   var errList = function (me) {
      var _p1 = me;
      if (_p1.ctor === "Just") {
            return _U.list([errMsg(_p1._0)]);
         } else {
            return _U.list([]);
         }
   };
   ...
   var avatarUrl = function (p) {
      var _p2 = p.avatarId;
      if (_p2.ctor === "Just") {
            return A2($Basics._op["++"],"/avatars/",_p2._0);
         } else {
   ...
   var fieldGroup = F4(function (label$,hint,errors,inputs) {
      var feedbacksEl = A2($Html.div,
      _U.list([$Html$Attributes.$class("feedback")]),
      _U.list([$Html.text(A2($String.join,
      " - ",
      A2($List.filter,
      function (_p5) {
         return $Basics.not($String.isEmpty(_p5));
      },
      A2($List._op["::"],hint,errors))))]));
      return A2($Html.div,
      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2"
                                                   ,_0: "row form-group"
                                                   ,_1: true}
                                                  ,{ctor: "_Tuple2"
                                                   ,_0: "with-error"
                                                   ,_1: $Basics.not($List.isEmpty(errors))}]))]),
      _U.list([A2(col$,
              3,
              ...
              ,A2(col$,
              9,
              A2($Basics._op["++"],inputs,_U.list([feedbacksEl])))]));
   });
   ...
   var actionGroup = function (content) {
      return row(_U.list([A2($Html.div,
...
Elm.View.Layout.make = function (_elm) {
   ...
   var layoutWithNav = F3(function (name,ctx,content) {
      var transitStyle = function () {
         var _p0 = ctx.routeTransition;
         if (_p0.ctor === "ForMain") {
               return A2($TransitStyle.fadeSlideLeft,40,ctx.transition);
            } else {
               return _U.list([]);
            }
      }();
...
Elm.Page.Login.View.make = function (_elm) {
   ...
   var errorLine = function (error) {
      ...
      _U.list([$Html$Attributes.$class("form-error-global")]),
      _U.list([$Html.text("Login failure. Wrong credentials?")])) : $Html.text("");
   };
   ...
   var registerForm = function (_p0) {
      ...
      var _p2 = function () {
         ...
         if (_p3.ctor === "Just") {
               ...
               return {ctor: "_Tuple2"
                      ,_0: A2($Html$Events.onClick,formAddr,$Form.submit)
                      ,_1: $Form.isSubmitted(_p4)};
            }
      }();
      var submitClick = _p2._0;
...
Elm.Date.Format.make = function (_elm) {
   ...
   var zero2twelve = function (n) {
      return _U.eq(n,0) ? 12 : n;
   };
...
Elm.Page.Admin.View.make = function (_elm) {
   ...
   var dashboardContent = F2(function (route,_p6) {
      var _p7 = _p6;
   ...
   var content = F4(function (route,ctx,item,_p8) {
      var _p9 = _p8;
      var _p12 = _p9;
      var tabContent = function () {
         var _p10 = item;
         switch (_p10.ctor)
         {case "DashboardTab": return A2(dashboardContent,route,_p12);
            case "TracksTab": return A2(tracksContent,route,_p12);
            default: return A2(usersContent,route,_p12);}
      }();
      var transitStyle = function () {
         var _p11 = ctx.routeTransition;
         if (_p11.ctor === "ForAdmin") {
               return A2($TransitStyle.fadeSlideLeft,40,ctx.transition);
            } else {
               return _U.list([]);
            }
