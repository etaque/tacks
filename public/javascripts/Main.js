...
Elm.Task.Extra.make = function (_elm) {
   ...
   var computeLazyAsync = F2(function (address,lazy) {
      ...
      function (f) {
         ...
         function (value) {
            return A2($Signal.send,address,value);
         });
      })),
      function (_p0) {
         return $Task.succeed({ctor: "_Tuple0"});
   ...
   var interceptError = F2(function (failAddress,task) {
      ...
      function (error) {
         return A2($Task.andThen,
         A2($Signal.send,failAddress,error),
         function (_p1) {
   ...
   var interceptSuccess = F2(function (successAddress,task) {
      ...
      function (value) {
         return A2($Task.andThen,
         A2($Signal.send,successAddress,value),
         function (_p2) {
   ...
   var intercept = F2(function (address,task) {
      ...
      function (error) {
         return A2($Task.andThen,
         A2($Signal.send,address,$Result.Err(error)),
         function (_p3) {
            return $Task.fail(error);
         });
      }),
      function (value) {
         return A2($Task.andThen,
         A2($Signal.send,address,$Result.Ok(value)),
         function (_p4) {
            return $Task.succeed(value);
         });
      });
   });
   var delay = F2(function (time,task) {
      return A2($Task.andThen,
      $Task.sleep(time),
      function (_p5) {
         return task;
   ...
   var optional = function (list) {
      ...
      if (_p8.ctor === "[]") {
            ...
            function (value) {
               return A2($Task.map,
               F2(function (x,y) {    return A2($List._op["::"],x,y);})(value),
               optional(_p10));
            }),
            function (_p9) {
   ...
   var parallel = function (tasks) {
      return $Task.sequence(A2($List.map,$Task.spawn,tasks));
   };
...
Elm.RouteParser.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var matchUrl = F3(function (url,parser,maybeRoute) {
      var _p0 = maybeRoute;
      if (_p0.ctor === "Just") {
            return maybeRoute;
         } else {
            var _p1 = A2($Combine.parse,parser,url);
            if (_p1.ctor === "_Tuple2" && _p1._0.ctor === "Done") {
   ...
   var dyn3 = F8(function (route,s1,pa,s2,pb,s3,pc,s4) {
      return A2($Combine.andThen,
      A2($Combine.andThen,
      A2($Combine$Infix._op["<$>"],
      route,
      A2($Combine$Infix._op["*>"],$Combine.string(s1),pa)),
      function (r) {
         return A2($Combine$Infix._op["<$>"],
         r,
         A2($Combine$Infix._op["*>"],$Combine.string(s2),pb));
      }),
      function (r) {
         return A2($Combine$Infix._op["<$>"],
         r,
         A2($Combine$Infix._op["<*"],
         A2($Combine$Infix._op["<*"],
         A2($Combine$Infix._op["*>"],$Combine.string(s3),pc),
         $Combine.string(s4)),
         $Combine.end));
      });
   });
   var dyn2 = F6(function (route,s1,pa,s2,pb,s3) {
      return A2($Combine.andThen,
      A2($Combine$Infix._op["<$>"],
      route,
      A2($Combine$Infix._op["*>"],$Combine.string(s1),pa)),
   ...
   var dyn1 = F4(function (route,s1,pa,s2) {
      return A2($Combine$Infix._op["<*"],
      A2($Combine$Infix._op["<*"],
      A2($Combine$Infix._op["<$>"],
      route,
...
Elm.Screens.Home.Types.make = function (_elm) {
   ...
   var FocusTrack = function (a) {
      return {ctor: "FocusTrack",_0: a};
   };
...
Elm.Screens.ShowTrack.Types.make = function (_elm) {
   ...
   var SetOverCourse = function (a) {
      return {ctor: "SetOverCourse",_0: a};
   };
   var LiveTrackResult = function (a) {
      return {ctor: "LiveTrackResult",_0: a};
   };
   var initial = {liveTrack: $Maybe.Nothing
                 ,notFound: false
                 ,courseControl: {over: false
                                 ,dragging: false
...
Elm.Screens.EditTrack.Types.make = function (_elm) {
   ...
   var modeName = function (mode) {
      ...
      {case "CreateTile": switch (_p2._0.ctor)
         ...
         case "Erase": return {ctor: "_Tuple2",_0: "s",_1: "Sand"};
         default: return {ctor: "_Tuple2"
                         ,_0: "m"
                         ,_1: "Move (press SHIFT for temporary move mode)"};}
   };
   var SetWindA2 = function (a) {
      return {ctor: "SetWindA2",_0: a};
   };
   var SetWindW2 = function (a) {
      return {ctor: "SetWindW2",_0: a};
   };
   var SetWindA1 = function (a) {
      return {ctor: "SetWindA1",_0: a};
   };
   ...
   var UpdateGustGen = function (a) {
      return {ctor: "UpdateGustGen",_0: a};
   };
   var SetLaps = function (a) {
      return {ctor: "SetLaps",_0: a};
   };
   var SetGateWidth = function (a) {
      return {ctor: "SetGateWidth",_0: a};
   };
   var SetUpwindY = function (a) {
      return {ctor: "SetUpwindY",_0: a};
   };
...
Elm.Screens.Game.Types.make = function (_elm) {
   ...
   var UpdateMessageField = function (a) {
      return {ctor: "UpdateMessageField",_0: a};
   };
...
Elm.Screens.ListDrafts.Types.make = function (_elm) {
   ...
   var CreateDraft = {ctor: "CreateDraft"};
   var SetDraftName = function (a) {
      return {ctor: "SetDraftName",_0: a};
   };
...
Elm.AppTypes.make = function (_elm) {
   ...
   var Context = F4(function (a,b,c,d) {
      return {player: a,dims: b,transitStatus: c,animValue: d};
   });
   ...
   var ShowProfileAction = function (a) {
      return {ctor: "ShowProfileAction",_0: a};
   };
   var EditTrackAction = function (a) {
      return {ctor: "EditTrackAction",_0: a};
   };
   var ShowTrackAction = function (a) {
      return {ctor: "ShowTrackAction",_0: a};
   };
   var RegisterAction = function (a) {
      return {ctor: "RegisterAction",_0: a};
   };
   var LoginAction = function (a) {
      return {ctor: "LoginAction",_0: a};
   };
   var HomeAction = function (a) {
      return {ctor: "HomeAction",_0: a};
   };
   var TransitionTick = F2(function (a,b) {
      return {ctor: "TransitionTick",_0: a,_1: b};
   });
   var TransitionStart = function (a) {
      return {ctor: "TransitionStart",_0: a};
   };
...
Elm.Game.Steps.GateCrossing.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var gateCrossedInX = F2(function (gate,_p0) {
      var _p1 = _p0;
      var _p3 = _p1._0._1;
      var _p2 = _p1._0._0;
      var a = (_p3 - _p1._1._1) / (_p2 - _p1._1._0);
      var b = _p3 - a * _p2;
      var xGate = (gate.y - b) / a;
      return _U.cmp($Basics.abs(xGate),gate.width / 2) < 1;
   });
   var gateCrossedFromNorth = F2(function (gate,_p4) {
      var _p5 = _p4;
      var _p7 = _p5._1;
      var _p6 = _p5._0;
      return _U.cmp($Basics.snd(_p6),
      gate.y) > 0 && (_U.cmp($Basics.snd(_p7),
      gate.y) < 1 && A2(gateCrossedInX,
      gate,
      {ctor: "_Tuple2",_0: _p6,_1: _p7}));
   });
   var gateCrossedFromSouth = F2(function (gate,_p8) {
      var _p9 = _p8;
      var _p11 = _p9._1;
      var _p10 = _p9._0;
      return _U.cmp($Basics.snd(_p10),
      gate.y) < 0 && (_U.cmp($Basics.snd(_p11),
      gate.y) > -1 && A2(gateCrossedInX,
      gate,
   ...
   var gateCrossingStep = F3(function (previousState,_p13,_p12) {
      var _p14 = _p13;
      var _p19 = _p14;
      var _p18 = _p14.course;
      var _p15 = _p12;
      var _p17 = _p15.crossedGates;
      var t = $Game$Models.raceTime(_p19);
      var started = $Game$Models.isStarted(_p19);
      var step = {ctor: "_Tuple2"
                 ,_0: previousState.position
                 ,_1: _p15.position};
      var newCrossedGates = function () {
         var _p16 = A2(getNextGate,_p18,$List.length(_p17));
         if (_p16.ctor === "Just") {
               switch (_p16._0.ctor)
               {case "StartLine": return started && A2(gateCrossedFromSouth,
                    _p18.downwind,
                    step) ? A2($List._op["::"],t,_p17) : _p17;
                  case "UpwindGate": return A2(gateCrossedFromSouth,
                    _p18.upwind,
                    step) ? A2($List._op["::"],t,_p17) : A2(gateCrossedFromSouth,
                    _p18.downwind,
                    step) ? A2($Maybe.withDefault,
                    _U.list([]),
                    $List.tail(_p17)) : _p17;
                  default: return A2(gateCrossedFromNorth,
                    _p18.downwind,
                    step) ? A2($List._op["::"],t,_p17) : A2(gateCrossedFromNorth,
                    _p18.upwind,
                    step) ? A2($Maybe.withDefault,
                    _U.list([]),
                    $List.tail(_p17)) : _p17;}
      ...
      {crossedGates: newCrossedGates,nextGate: nextGate});
   });
   return _elm.Game.Steps.GateCrossing.values = {_op: _op
...
Elm.Game.Steps.Util.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var polarSpeed = F2(function (windSpeed,windAngle) {
      var x2 = $Basics.abs(windAngle);
      var x1 = windSpeed;
      var y = -2.067174789 * Math.pow(10,-3) * Math.pow(x1,
      3) - 1.868941044 * Math.pow(10,-4) * Math.pow(x1,
      2) * x2 - 1.03401471 * Math.pow(10,-4) * x1 * Math.pow(x2,
      2) - 1.86799863 * Math.pow(10,-5) * Math.pow(x2,
      3) + 7.376288713 * Math.pow(10,-2) * Math.pow(x1,
      2) + 3.19606466 * Math.pow(10,
      -2) * x1 * x2 + 2.939457021 * Math.pow(10,-3) * Math.pow(x2,
      2) - 8.575945237 * Math.pow(10,
      -1) * x1 + 9.427801906 * Math.pow(10,-5) * x2 + 4.342327445;
      return y * 2;
   });
   var knFactor = 1.852;
   ...
   return _elm.Game.Steps.Util.values = {_op: _op
                                        ,knFactor: knFactor
                                        ,mpsToKn: mpsToKn
                                        ,knToMps: knToMps
...
Elm.Game.Steps.Moving.make = function (_elm) {
   ...
   var isGrounded = F2(function (p,course) {
      ...
      var ul = _p0._0;
      var ur = _p0._1;
      var _p1 = $Game$Models.getGateMarks(course.downwind);
      var dl = _p1._0;
      var dr = _p1._1;
      var marks = _U.list([dl,dr,ul,ur]);
      var stuckOnMark = A2($Game$Core.exists,
      function (m) {
         return _U.cmp(A2($Game$Geo.distance,p,m),
   ...
   targetVelocity) {
      ...
      var realAccel = _U.cmp(accel,0) > 0 ? A2($Basics.min,
      accel,
      maxAccel) : A2($Basics.max,accel,0 - maxAccel);
      return previousVelocity + realAccel * elapsed;
   });
   var movingStep = F3(function (elapsed,course,state) {
      if (_U.eq(elapsed,0)) return state; else {
            ...
            nextVelocity,
            state.heading);
            var grounded = A2(isGrounded,nextPosition,course);
            var position = grounded ? state.position : nextPosition;
            var trail = A2($List.take,
            20,
            A2($List._op["::"],position,state.trail));
   ...
   return _elm.Game.Steps.Moving.values = {_op: _op
                                          ,maxAccel: maxAccel
...
Elm.Game.Steps.Turning.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var autoVmgTarget = F2(function (state,input) {
   ...
   var getTackTarget = F3(function (state,input,targetReached) {
      if ($Game$Inputs.manualTurn(input)) return $Maybe.Nothing;
      else {
            var _p0 = state.tackTarget;
            if (_p0.ctor === "Just") {
   ...
   var autoTack = 8.0e-2;
   var slow = 3.0e-2;
   var getTurn = F4(function (tackTarget,state,input,elapsed) {
      if ($Game$Inputs.manualTurn(input))
      return $Basics.toFloat(input.arrows.x) * elapsed * (input.subtleTurn ? slow : fast);
      else {
            var _p1 = tackTarget;
            if (_p1.ctor === "Just") {
                  ...
                  var _p2 = state.controlMode;
                  if (_p2.ctor === "FixedHeading") {
                        return 0;
                     } else {
   ...
   var turningStep = F3(function (elapsed,input,state) {
      var targetReached = tackTargetReached(state);
      var tackTarget = A3(getTackTarget,state,input,targetReached);
      var turn = A4(getTurn,tackTarget,state,input,elapsed);
      var heading = $Game$Geo.ensure360(state.heading + turn);
      var windAngle = A2($Game$Geo.angleDelta,
      heading,
      state.windOrigin);
      var lock = input.lock || _U.cmp(input.arrows.y,0) > 0;
      ...
      {heading: heading
      ,windAngle: windAngle
      ,isTurning: $Game$Inputs.isTurning(input)
      ,tackTarget: tackTarget
      ,controlMode: newControlMode});
   });
   return _elm.Game.Steps.Turning.values = {_op: _op
                                           ,slow: slow
                                           ,autoTack: autoTack
                                           ,fast: fast
...
Elm.Game.Steps.Vmg.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var getVmgValue = F2(function (windAngle,boatSpeed) {
      return $Basics.abs($Basics.sin($Game$Core.toRadians(windAngle)) * boatSpeed);
   });
   var makeVmg = F2(function (windSpeed,windAngle) {
      var boatSpeed = A2($Game$Steps$Util.polarSpeed,
      windSpeed,
      windAngle);
      var value = A2(getVmgValue,windAngle,boatSpeed);
      return {angle: windAngle,speed: windSpeed,value: value};
   });
   ...
   maxAngle) {
      ...
      makeVmg(windSpeed),
      A2($Game$Core.floatRange,minAngle,maxAngle));
      var bestMaybe = $List.head($List.reverse(A2($List.sortBy,
      function (_) {
         return _.value;
      },
      vmgs)));
      return A2($Maybe.withDefault,$Game$Models.defaultVmg,bestMaybe);
   });
   var getUpwindVmg = function (windSpeed) {
      return A3(findVmgInInterval,windSpeed,40,60);
   };
   var getDownwindVmg = function (windSpeed) {
      return A3(findVmgInInterval,windSpeed,130,150);
   };
   var vmgStep = function (state) {
      var downwindVmg = getDownwindVmg(state.windSpeed);
      var upwindVmg = getUpwindVmg(state.windSpeed);
      var vmgValue = A2(getVmgValue,state.windAngle,state.velocity);
      return _U.update(state,
      {vmgValue: vmgValue
      ,upwindVmg: upwindVmg
      ,downwindVmg: downwindVmg});
   };
   return _elm.Game.Steps.Vmg.values = {_op: _op
                                       ,vmgStep: vmgStep
                                       ,makeVmg: makeVmg
...
Elm.Game.Steps.PlayerWind.make = function (_elm) {
   ...
   var shadowArc = 30;
   var windShadowSector = function (_p0) {
      var _p1 = _p0;
      var _p2 = _p1.shadowDirection;
      return {ctor: "_Tuple2"
             ,_0: $Game$Geo.ensure360(_p2 - shadowArc / 2)
             ,_1: $Game$Geo.ensure360(_p2 + shadowArc / 2)};
   };
   var inShadow = F2(function (state,opponent) {
      return _U.cmp(A2($Game$Geo.distance,
      opponent.state.position,
      state.position),
      $Game$Models.windShadowLength) < 1 && function () {
         var _p3 = windShadowSector(opponent.state);
         var min = _p3._0;
         var max = _p3._1;
         var angle = A2($Game$Geo.angleBetween,
         opponent.state.position,
         state.position);
         return A3($Game$Geo.inSector,min,max,angle);
      }();
   });
   var shadowSpeedImpact = -5;
   var playerWindStep = F2(function (_p4,state) {
      var _p5 = _p4;
      var _p7 = _p5.wind;
      var windShadow = $List.sum(A2($List.map,
      function (_p6) {
         return shadowSpeedImpact;
      },
      A2($List.filter,inShadow(state),_p5.opponents)));
      var gustTiles = A2($List.filterMap,
      findGustTile(state.position),
      A2($List.map,
      function (_) {
         return _.tiles;
      },
      A2($List.filter,isGustOnPlayer(state),_p5.gusts.gusts)));
      var gustOrigin = $List.sum(A2($List.map,
      function (_) {
         return _.angle;
      },
      gustTiles));
      var newOrigin = $Game$Geo.ensure360(_p7.origin + gustOrigin);
      ...
      gustTiles));
      var speed = _p7.speed + gustSpeed + windShadow;
   ...
   return _elm.Game.Steps.PlayerWind.values = {_op: _op
...
Elm.Game.Steps.Gusts.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var genGustTile = F3(function (grid,_p0,coords) {
      var _p1 = _p0;
      var _p2 = _p1.radius;
   ...
   var genTiledGust = F2(function (grid,_p3) {
      ...
      coordsList));
      return A3($Game$Models.TiledGust,_p5,_p6,tiles);
   });
   var genTiledGusts = F3(function (grid,now,_p7) {
      var _p8 = _p7;
      return {genTime: now
             ,gusts: A2($List.map,genTiledGust(grid),_p8.gusts)};
   });
   var interval = 500;
   var gustsStep = function (_p9) {
      var _p10 = _p9;
      var _p12 = _p10.timers;
      var _p11 = _p10;
      return _U.cmp(_p10.gusts.genTime + interval,
      _p12.now) < 0 ? _U.update(_p11,
      {gusts: A3(genTiledGusts,
      _p10.course.grid,
      _p12.now,
      _p10.wind)}) : _p11;
   };
   return _elm.Game.Steps.Gusts.values = {_op: _op
                                         ,interval: interval
                                         ,gustsStep: gustsStep
...
Elm.Game.Steps.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var raceEscapeStep = F2(function (doEscape,playerState) {
      var crossedGates = doEscape ? _U.list([]) : playerState.crossedGates;
      return _U.update(playerState,{crossedGates: crossedGates});
   });
   var playerTimeStep = F2(function (elapsed,state) {
      return _U.update(state,{time: state.time + elapsed});
   });
   var moveOpponentState = F2(function (state,delta) {
      var position = A4($Game$Geo.movePoint,
      state.position,
      delta,
      state.velocity,
      state.heading);
      return _U.update(state,{position: position});
   });
   var updateOpponent = F3(function (previousMaybe,
   delta,
   opponent) {
      var _p0 = previousMaybe;
      if (_p0.ctor === "Just") {
            return _U.eq(_p0._0.state.time,
            opponent.state.time) ? _U.update(opponent,
            {state: A2(moveOpponentState,opponent.state,delta)}) : opponent;
         } else {
            return opponent;
         }
   });
   ...
   newOpponents) {
      var findPrevious = function (o) {
         return A2($Game$Core.find,
         function (po) {
            return _U.eq(po.player.id,o.player.id);
         },
         previousOpponents);
      };
      return A2($List.map,
      function (o) {
         return A3(updateOpponent,findPrevious(o),delta,o);
      },
      newOpponents);
   });
   ...
   var centerStep = F3(function (_p2,dims,_p1) {
      var _p3 = _p2;
      var _p4 = _p1;
      var _p5 = $Game$Models.areaBox(_p4.course.area);
      var xMax = _p5._0._0;
      var yMax = _p5._0._1;
      var xMin = _p5._1._0;
      var yMin = _p5._1._1;
      var _p6 = $Game$Geo.floatify(dims);
      var w = _p6._0;
      var h = _p6._1;
      var _p7 = _p4.playerState.position;
      var px$ = _p7._0;
      var py$ = _p7._1;
      var _p8 = _p4.center;
      var cx = _p8._0;
      var cy = _p8._1;
      var newCenter = {ctor: "_Tuple2"
                      ,_0: A6(axisCenter,_p3._0,px$,cx,w,xMin,xMax)
                      ,_1: A6(axisCenter,_p3._1,py$,cy,h,yMin,yMax)};
      return _U.update(_p4,{center: newCenter});
   });
   var playerStep = F3(function (keyboardInput,elapsed,gameState) {
      var playerState = A2(raceEscapeStep,
      keyboardInput.escapeRace,
      A2(playerTimeStep,
      elapsed,
      A3($Game$Steps$GateCrossing.gateCrossingStep,
      gameState.playerState,
      gameState,
      A3($Game$Steps$Moving.movingStep,
      elapsed,
      gameState.course,
      $Game$Steps$Vmg.vmgStep(A2($Game$Steps$PlayerWind.playerWindStep,
      gameState,
      A3($Game$Steps$Turning.turningStep,
      elapsed,
      keyboardInput,
      gameState.playerState)))))));
      return _U.update(gameState,{playerState: playerState});
   });
   var raceInputStep = F3(function (raceInput,_p10,_p9) {
      var _p11 = _p10;
      var _p19 = _p11.time;
      var _p18 = _p11.delta;
      var _p12 = _p9;
      var _p17 = _p12.timers;
      var _p16 = _p12;
      var _p13 = raceInput;
      var serverNow = _p13.serverNow;
      var startTime = _p13.startTime;
      var opponents = _p13.opponents;
      var ghosts = _p13.ghosts;
      var tallies = _p13.tallies;
      var initial = _p13.initial;
      var clientTime = _p13.clientTime;
      var rtd = function () {
         var _p14 = _p17.rtd;
         if (_p14.ctor === "Just") {
               return A2($Basics.min,_p14._0,_p19 - clientTime);
            } else {
               return _p19 - clientTime;
            }
      }();
      var compensedServerNow = serverNow - rtd / 2;
      var now = function () {
         var _p15 = _p17.serverNow;
         if (_p15.ctor === "Just") {
               return A2($Basics.min,_p15._0 + _p18,compensedServerNow);
            } else {
      ...
      _p18,
      opponents);
      var newTimers = _U.update(_p17,
      {serverNow: $Maybe.Just(serverNow)
      ,now: now
      ,startTime: startTime
      ,localTime: _p19
      ,rtd: $Maybe.Just(rtd)});
      return _U.update(_p16,
...
Elm.Screens.Game.Updates.make = function (_elm) {
   ...
   var applyLiveTrack = F2(function (_p0,screen) {
      ...
      var inRace = function (p) {
         return A2($List.member,p,racePlayers);
      };
...
Elm.AppUpdates.make = function (_elm) {
   ...
   appState) {
      ...
      function (_p4) {
         return $AppTypes.ScreenAction(actionWrapper(_p4));
      },
      _p3._1);
      var newState = _U.update(appState,
      {screens: A2(screensUpdater,_p3._0,appState.screens)});
   ...
   var updateScreen = F2(function (screenAction,_p5) {
      var _p6 = _p5;
      var _p10 = _p6.screens;
      var _p9 = _p6.ctx;
      var _p8 = _p6;
      var _p7 = screenAction;
      switch (_p7.ctor)
      {case "HomeAction": return A2(applyHome,
           A2($Screens$Home$Updates.update,_p7._0,_p10.home),
           _p8);
         case "LoginAction": return A2(applyLogin,
           A2($Screens$Login$Updates.update,_p7._0,_p10.login),
           _p8);
         case "RegisterAction": return A2(applyRegister,
           A2($Screens$Register$Updates.update,_p7._0,_p10.register),
           _p8);
         case "ShowTrackAction": return A2(applyShowTrack,
           A2($Screens$ShowTrack$Updates.update,_p7._0,_p10.showTrack),
           _p8);
         ...
         case "ShowProfileAction": return A2(applyShowProfile,
           A2($Screens$ShowProfile$Updates.update,_p7._0,_p10.showProfile),
           _p8);
         case "GameAction": return A2(applyGame,
           A3($Screens$Game$Updates.update,_p9.player,_p7._0,_p10.game),
           _p8);
         case "ListDraftsAction": return A2(applyListDrafts,
           A2($Screens$ListDrafts$Updates.update,_p7._0,_p10.listDrafts),
           _p8);
         default: return A2(applyAdmin,
           A2($Screens$Admin$Updates.update,_p7._0,_p10.admin),
           _p8);}
   });
   var mountRoute = F2(function (_p11,route) {
      var _p12 = _p11;
      var _p15 = _p12.ctx;
      var _p14 = _p12;
      var _p13 = route;
      ...
      {case "Home": return A2(applyHome,
           $Screens$Home$Updates.mount(_p15.player),
           _p14);
         ...
         case "ShowProfile": return A2(applyShowProfile,
           $Screens$ShowProfile$Updates.mount(_p15.player),
           _p14);
         case "ShowTrack": return A2(applyShowTrack,
           $Screens$ShowTrack$Updates.mount(_p13._0),
           _p14);
         case "EditTrack": return A2(applyEditTrack,
           $Screens$EditTrack$Updates.mount(_p13._0),
           _p14);
         case "PlayTrack": return A2(applyGame,
           $Screens$Game$Updates.mount(_p13._0),
           _p14);
   ...
   var updateTransitionAnim = F2(function (_p16,step) {
      var _p17 = _p16;
      var _p22 = _p17;
      var _p18 = step;
      if (_p18.ctor === "TransitionStart") {
            var anim = A2($Animation.duration,
            200,
            $Animation.animation(_p18._0));
            return A2($AppTypes._op["&:"],
            _p22,
            $Effects.tick($AppTypes.TransitionTick(anim)));
         } else {
            var _p21 = _p18._1;
            var _p20 = _p18._0;
            var _p19 = A2($Animation.isDone,_p21,_p20) ? {ctor: "_Tuple2"
                                                         ,_0: $Maybe.Nothing
                                                         ,_1: $Effects.none} : {ctor: "_Tuple2"
                                                                               ,_0: $Maybe.Just(A2($Animation.animate,_p21,_p20))
                                                                               ,_1: $Effects.tick($AppTypes.TransitionTick(_p20))};
            var animValue = _p19._0;
            var fx = _p19._1;
            return A2($AppTypes._op["&:"],
            _U.update(_p22,
            {ctx: _U.update(_p17.ctx,{animValue: animValue})}),
            fx);
         }
   });
   var triggerAnim = function (_p23) {
      var _p24 = _p23;
      var newState = _U.update(_p24._0,
      {ctx: _U.update(_p24._0.ctx,{animValue: $Maybe.Just(0)})});
      var animTick = function (_p25) {
         return $AppTypes.TransitionAction($AppTypes.TransitionStart(_p25));
      };
      return {ctor: "_Tuple2"
             ,_0: newState
             ,_1: $Effects.batch(_U.list([_p24._1
                                         ,$Effects.tick(animTick)]))};
   };
   var needsTransition = F2(function (before,after) {
      if (_U.eq(before,after)) return false; else {
            var _p26 = {ctor: "_Tuple2",_0: before,_1: after};
            if (_p26.ctor === "_Tuple2" && _p26._0.ctor === "Just" && _p26._0._0.ctor === "Admin" && _p26._1.ctor === "Just" && _p26._1._0.ctor === "Admin")
            {
                  return false;
               } else {
                  return true;
   ...
   var update = F2(function (appAction,_p27) {
      var _p28 = _p27;
      var _p40 = _p28.ctx;
      var _p39 = _p28;
      var _p29 = appAction;
      ...
      {case "SetPath": return A2($AppTypes._op["&!"],
           ...
           $History.setPath(_p29._0)));
         case "PathChanged": var _p31 = _p29._0;
           var newRoute = A2($RouteParser.match,$Routes.routeParsers,_p31);
           var fx = $Effects.task($Task.succeed($AppTypes.MountRoute(newRoute)));
           var newCtx = _U.update(_p40,{transitStatus: $AppTypes.Exit});
           var newAppState = _U.update(_p39,{path: _p31,ctx: newCtx});
           return A2($AppTypes._op["&:"],newAppState,fx);
         case "MountRoute": var _p33 = _p29._0;
           var newCtx = _U.update(_p40,{transitStatus: $AppTypes.Enter});
           var newAppState = _U.update(_p39,{route: _p33,ctx: newCtx});
           var _p32 = newAppState.route;
           if (_p32.ctor === "Just") {
                 return A2(needsTransition,
                 _p39.route,
                 _p33) ? triggerAnim(A2(mountRoute,
                 newAppState,
                 _p32._0)) : A2($AppTypes._op["&:"],newAppState,$Effects.none);
              } else {
                 return A2($AppTypes._op["&:"],newAppState,$Effects.none);
              }
         case "TransitionAction": return A2(mapEffect,
           $AppTypes.TransitionAction,
           A2(updateTransitionAnim,_p39,_p29._0));
         case "SetPlayer": var fx = A2($Effects.map,
           function (_p34) {
              return $AppTypes.AppNoOp;
           },
           $Screens$UpdateUtils.redirect($Routes.Home));
           var newCtx = _U.update(_p40,{player: _p29._0});
           return A2($AppTypes._op["&:"],_U.update(_p39,{ctx: newCtx}),fx);
         case "UpdateDims": return A2($AppTypes._op["&:"],
           _U.update(_p39,{ctx: _U.update(_p40,{dims: _p29._0})}),
           $Effects.none);
         case "MouseEvent": var handlerMaybe = function () {
              ...
              _v13_2: do {
                 if (_p35.ctor === "Just") {
                       switch (_p35._0.ctor)
                       {case "EditTrack": return $Maybe.Just(function (_p36) {
                               return $AppTypes.EditTrackAction($Screens$EditTrack$Updates.mouseAction(_p36));
                            });
                          case "ShowTrack": return $Maybe.Just(function (_p37) {
                               return $AppTypes.ShowTrackAction($Screens$ShowTrack$Updates.mouseAction(_p37));
                            });
                          default: break _v13_2;}
                    } else {
                       break _v13_2;
                    }
              } while (false);
           ...
           var _p38 = handlerMaybe;
           if (_p38.ctor === "Just") {
                 return A2(updateScreen,_p38._0(_p29._0),_p39);
              } else {
                 return A2($AppTypes._op["&:"],_p39,$Effects.none);
              }
         case "Logout": return A2($AppTypes._op["&!"],_p39,logoutTask);
         case "ScreenAction": return A2(updateScreen,_p29._0,_p39);
         default: return A2($AppTypes._op["&:"],_p39,$Effects.none);}
   });
   ...
   return _elm.AppUpdates.values = {_op: _op
                                   ...
                                   ,updateTransitionAnim: updateTransitionAnim
                                   ,mountRoute: mountRoute
...
Elm.Screens.Utils.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var colWidth = function (col) {
      return ($Constants.containerWidth + $Constants.gutterWidth) / 12 * $Basics.toFloat(col) - $Constants.gutterWidth;
   };
   var formatTimer = F2(function (showMs,t) {
   ...
   var avatarUrl = function (p) {
      var _p0 = p.avatarId;
      if (_p0.ctor === "Just") {
            return A2($Basics._op["++"],"/avatars/",_p0._0);
         } else {
   ...
   var playerWithAvatar = function (player) {
      ...
      _U.list([$Html$Attributes.$class("handle")]),
      _U.list([$Html.text(playerHandle(player))]));
      var avatarImg = A2($Html.img,
      _U.list([$Html$Attributes.src(avatarUrl(player))
   ...
   var formGroup = F2(function (hasErr,content) {
      return A2($Html.div,
   ...
   var abbr$ = F2(function ($short,$long) {
      return A2($Html.abbr,
      _U.list([$Html$Attributes.title($long)]),
      _U.list([$Html.text($short)]));
   });
   ...
   $Json$Decode.string,
   $String.toInt));
   var onIntInput = F2(function (address,contentToValue) {
...
Elm.Screens.Layout.make = function (_elm) {
   ...
   var layoutWithNav = F3(function (name,ctx,content) {
      var transform = function (v) {
         return A2($Basics._op["++"],
         "translateX(",
         A2($Basics._op["++"],$Basics.toString(40 - v * 40),"px)"));
      };
      var transitionStyle = function () {
         var _p1 = ctx.animValue;
         if (_p1.ctor === "Just") {
               var _p2 = _p1._0;
               return _U.list([{ctor: "_Tuple2"
                               ,_0: "opacity"
                               ,_1: $Basics.toString(_p2)}
                              ,{ctor: "_Tuple2",_0: "transform",_1: transform(_p2)}]);
            } else {
               return _U.list([]);
            }
      }();
      ...
      _U.list([$Html$Attributes.$class(A2($Basics._op["++"],
              ...
              ,$Html$Attributes.style(transitionStyle)]),
      content)]));
   });
...
Elm.Screens.Home.View.make = function (_elm) {
   ...
   var playersList = function (players) {
      return A2($Html.ul,
      _U.list([$Html$Attributes.$class("list-unstyled live-players")]),
      A2($List.map,playerItem,players));
   };
   var activeTrackPlayers = function (_p0) {
      var _p1 = _p0;
      var _p2 = _p1.track;
      return A2($Html.div,
   ...
   var activePlayers = function (liveTracks) {
      var activeLiveTracks = $List.reverse(A2($List.sortBy,
      function (lt) {
         return $List.length(lt.players);
      },
      A2($List.filter,
      function (lt) {
         return $Basics.not($List.isEmpty(lt.players));
      },
      liveTracks)));
      var content = $List.isEmpty(activeLiveTracks) ? _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("empty")]),
      _U.list([$Html.text("Nobody\'s playing right now.")]))]) : A2($List.map,
      activeTrackPlayers,
      activeLiveTracks);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("active-players")]),
      A2($List._op["::"],
      A2($Html.h2,
      _U.list([]),
   ...
   var liveTrackBlock = F2(function (maybeTrackId,_p3) {
      ...
      var _p6 = _p4.players;
      var _p5 = _p4.meta;
      var empty = _U.eq($List.length(_p6),0);
      var hasFocus = _U.eq(maybeTrackId,$Maybe.Just(_p7.id));
      return A2($Html.div,
      ...
      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2"
                                                   ,_0: "live-track"
                                                   ,_1: true}
                                                  ,{ctor: "_Tuple2",_0: "has-focus",_1: hasFocus}
                                                  ,{ctor: "_Tuple2",_0: "is-empty",_1: empty}]))]),
      _U.list([A2($Html.div,
              ...
              " (",
              A2($Basics._op["++"],
              $Basics.toString($List.length(_p6)),
              ")"))))]))]))]));
   });
   var liveTracks = F3(function (player,_p8,maybeTrackId) {
      var _p9 = _p8;
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("live-tracks")]),
      _U.list([A2($Html.h2,
              _U.list([]),
              _U.list([$Html.text("Sailing tracks")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("row")]),
              A2($List.map,liveTrackBlock(maybeTrackId),_p9.liveTracks))]));
   });
...
Elm.Screens.Login.View.make = function (_elm) {
   ...
   var errorLine = function (error) {
      ...
      _U.list([$Html$Attributes.$class("form-errors alert alert-danger")]),
      _U.list([$Html.text("Login failure. Wrong credentials?")])) : A2($Html.div,
      _U.list([]),
      _U.list([]));
   };
...
Elm.Screens.Register.View.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var fieldError = F2(function (formErrors,field) {
      var _p0 = A2($Dict.get,field,formErrors);
      if (_p0.ctor === "Just") {
            return A2($Html.div,
            _U.list([$Html$Attributes.$class("error-message")]),
            _U.list([$Html.text(A2($String.join,", ",_p0._0))]));
         } else {
            return A2($Html.span,_U.list([]),_U.list([]));
         }
   });
   var hasError = F2(function (formErrors,field) {
      return $CoreExtra.isJust(A2($Dict.get,field,formErrors));
   });
   var registerForm = function (_p1) {
      var _p2 = _p1;
      var _p3 = _p2.errors;
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("form-login")]),
...
Elm.Screens.ShowTrack.View.make = function (_elm) {
   ...
   var renderCourse = F2(function (_p0,course) {
      ...
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.width($Basics.toString(w))
              ,$Svg$Attributes.height($Basics.toString(h))]),
      _U.list([A2($Svg.g,
      _U.list([$Svg$Attributes.transform(A2($Basics._op["++"],
      scaleTr,
      A2($Game$Render$SvgUtils.translate,cx,cy)))]),
      _U.list([$Game$Render$Tiles.lazyRenderTiles(course.grid)
              ,A2($Game$Render$Gates.renderOpenGate,course.upwind,0)
              ,A2($Game$Render$Gates.renderOpenGate,course.downwind,0)
              ,A2($Game$Render$Players.renderPlayerHull,0,0)]))]));
   });
   var courseBlock = F2(function (control,course) {
      return A2($Html.div,
   ...
   var withLiveTrack = F2(function (control,_p11) {
      ...
      _U.list([A2($Html.h1,
              _U.list([]),
              _U.list([$Html.text("Sailing track")]))
              ,A2($Html.div,
...
Elm.Screens.EditTrack.SideView.make = function (_elm) {
   ...
   var renderSurfaceMode = F2(function (currentMode,mode) {
      ...
      var color = function () {
         ...
         switch (_p2.ctor)
         {case "CreateTile":
            return $Game$Render$Tiles.tileKindColor(_p2._0);
            case "Erase": return $Constants.colors.sand;
   ...
   var view = F2(function (track,_p3) {
      ...
      return _U.list([$Screens$Sidebar.logo
                     ...
                     _U.list([A2($Html.div,
                             ...
                             _U.list([A2($Html.label,
                                     _U.list([$Html$Attributes.$class("")]),
                                     _U.list([$Html.text("Spawn interval (s)")]))
                                     ,A3(intInput,
                             ...
                             _U.list([A2($Html.label,
                                     _U.list([$Html$Attributes.$class("")]),
                                     _U.list([$Html.text("Average radius")]))
                                     ,A3(intInput,
                             ...
                             _U.list([A2($Html.label,
                                     _U.list([$Html$Attributes.$class("")]),
                                     _U.list([$Html.text("Radius variation (+/-)")]))
                                     ,A3(intInput,
                             ...
                             ,A2($Html.div,
                             _U.list([$Html$Attributes.$class("form-group range")]),
                             _U.list([A2($Html.label,
                                     _U.list([$Html$Attributes.$class("")]),
                                     _U.list([$Html.text("Wind speed variation")]))
                                     ,A3(intInput,
                             ...
                             _U.list([A2($Html.label,
                                     _U.list([$Html$Attributes.$class("")]),
                                     _U.list([$Html.text("Wind origin variation")]))
                                     ,A3(intInput,
...
Elm.Screens.EditTrack.View.make = function (_elm) {
   ...
   var renderCourse = F2(function (dims,_p0) {
      ...
      "scale(1,-1)",
      A2($Game$Render$SvgUtils.translate,cx,cy)))]),
      _U.list([$Game$Render$Tiles.lazyRenderTiles(_p4.grid)
...
Elm.Screens.Game.ChatView.make = function (_elm) {
   ...
   var messagesList = function (messages) {
      ...
      A2($List.map,messageItem,$List.reverse(messages)));
   };
   var view = F2(function (h,_p2) {
      var _p3 = _p2;
      var _p4 = _p3.messages;
      var messagesDiv = $List.isEmpty(_p4) ? A2($Html.div,
      _U.list([]),
      _U.list([])) : A2($Html.div,
      _U.list([$Html$Attributes.$class("messages")
              ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                               ,_0: "maxHeight"
                                               ,_1: A2($Basics._op["++"],
                                               $Basics.toString((h / 3 | 0) * 2),
                                               "px")}]))]),
      _U.list([messagesList(_p4)]));
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("module-chat")]),
      _U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text("Chat")]))
              ,messagesDiv
...
Elm.Screens.Game.PlayersView.make = function (_elm) {
   ...
   var tallyItem = F2(function (i,_p0) {
      var _p1 = _p0;
      var _p2 = _p1.gates;
   ...
   var raceItem = function (_p3) {
      var _p4 = _p3;
      var formatted = A2($Date$Format.format,
      "%H:%M",
      $Date.fromTime(_p4.startTime));
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("race")]),
      _U.list([A2($Html.h4,
              _U.list([]),
              _U.list([$Html.text(A2($Basics._op["++"],
              "on race started at ",
              ...
              A2($List.indexedMap,tallyItem,_p4.tallies))]));
   };
   var racesBlock = function (races) {
      var isActive = function (r) {
         return $Basics.not($List.isEmpty(r.players));
      };
      var activeRaces = A2($List.filter,isActive,races);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("list-races")]),
      A2($List.map,raceItem,activeRaces));
   };
   var block = function (_p5) {
      var _p6 = _p5;
...
Elm.Screens.Game.SideView.make = function (_elm) {
   ...
   var helpItems = A2($List.concatMap,
   helpItem,
   _U.list([{ctor: "_Tuple2",_0: "LEFT/RIGHT",_1: "turn"}
           ,{ctor: "_Tuple2",_0: "LEFT/RIGHT + SHIFT",_1: "adjust"}
           ,{ctor: "_Tuple2",_0: "ENTER",_1: "lock angle to wind"}
           ,{ctor: "_Tuple2",_0: "SPACE",_1: "tack or jibe"}
...
Elm.Screens.Admin.View.make = function (_elm) {
   ...
   var usersContent = F2(function (route,_p2) {
      var _p3 = _p2;
      return _U.list([A2($Html.ul,
      ...
      function (u) {
         return A2(userItem,
         _U.eq(route,$Routes.ListUsers($Maybe.Just(u.id))),
         u);
      },
      _p3.users))]);
   });
   ...
   var tracksContent = F2(function (route,_p4) {
      var _p5 = _p4;
      return _U.list([A2($Html.ul,
      ...
      function (t) {
         return A2(trackItem,
         _U.eq(route,$Routes.ListTracks($Maybe.Just(t.id))),
         t);
      },
      _p5.tracks))]);
   });
   ...
   var content = F3(function (route,item,_p8) {
      var _p9 = _p8;
      var _p11 = _p9;
      var _p10 = item;
      switch (_p10.ctor)
   ...
   var view = F3(function (ctx,route,screen) {
      ...
      _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Admin")]))
              ,menu(menuItem)]),
      A3(content,route,menuItem,screen)))]));
   });
   ...
   var routeView = F2(function (_p0,route) {
      ...
      {case "Home": return A2($Screens$Home$View.view,_p3,_p4.home);
         ...
         case "ListDrafts": return A2($Screens$ListDrafts$View.view,
           _p3,
           _p4.listDrafts);
         default: return A3($Screens$Admin$View.view,
           _p3,
           _p2._0,
           _p4.admin);}
   });
...
Elm.Main.make = function (_elm) {
   ...
   function (_p0) {
      var _p1 = _p0;
      return {time: _p1._0,delta: _p1._1};
   },
   ...
   var mouseEventActions = A2($Signal.map,
   $AppTypes.MouseEvent,
   ...
   function (v) {
      return v === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v === "object" && "serverNow" in v && "startTime" in v && "wind" in v && "opponents" in v && "ghosts" in v && "tallies" in v && "initial" in v && "clientTime" in v ? {_: {}
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                ,wind: typeof v.wind === "object" && "origin" in v.wind && "speed" in v.wind && "gusts" in v.wind && "gustCounter" in v.wind ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                               v.wind.gusts)
                                                                                                                                                                                                                                                                                                                                                                                               ,gustCounter: typeof v.wind.gustCounter === "number" && isFinite(v.wind.gustCounter) && Math.floor(v.wind.gustCounter) === v.wind.gustCounter ? v.wind.gustCounter : _U.badPort("an integer",
   ...
   function (v) {
      return v.ctor === "Nothing" ? null : {state: {time: v._0.state.time
                                                   ,position: [v._0.state.position._0,v._0.state.position._1]
                                           ...
                                           ,input: {arrows: {x: v._0.input.arrows.x,y: v._0.input.arrows.y}
   ...
   return _elm.Main.values = {_op: _op
                             ...
                             ,mouseEventActions: mouseEventActions
                             ,rawInput: rawInput
