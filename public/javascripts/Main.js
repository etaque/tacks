...
Elm.Models.make = function (_elm) {
   ...
   var GustGenerator = F2(function (a,b) {
      return {interval: a,defs: b};
   });
...
Elm.Screens.EditTrack.Types.make = function (_elm) {
   ...
   var SetGustSpeed = F2(function (a,b) {
      return {ctor: "SetGustSpeed",_0: a,_1: b};
   });
   var SetGustAngle = F2(function (a,b) {
      return {ctor: "SetGustAngle",_0: a,_1: b};
   });
   var RemoveGustDef = function (a) {
      return {ctor: "RemoveGustDef",_0: a};
   };
   var CreateGustDef = {ctor: "CreateGustDef"};
   var SetGustInterval = function (a) {
      return {ctor: "SetGustInterval",_0: a};
   };
...
Elm.Encoders.make = function (_elm) {
   ...
   var gustDefEncoder = function (d) {
      return $Json$Encode.object(_U.list([A2(_op["=>"],
                                         ...
                                         ,A2(_op["=>"],"speed",$Json$Encode.$float(d.speed))
                                         ,A2(_op["=>"],"radius",$Json$Encode.$float(d.radius))]));
   };
   var gustGeneratorEncoder = function (g) {
      return $Json$Encode.object(_U.list([A2(_op["=>"],
                                         ...
                                         ,A2(_op["=>"],
                                         "defs",
                                         $Json$Encode.list(A2($List.map,gustDefEncoder,g.defs)))]));
   };
...
Elm.Screens.EditTrack.FormUpdates.make = function (_elm) {
   ...
   var updateGustDefs = F2(function (update,gen) {
      return _U.update(gen,{defs: update(gen.defs)});
   });
   ...
   var update = F2(function (fu,course) {
      ...
      {case "SetUpwindY": return A2(updateUpwindY,_p6._0,course);
         ...
         case "SetGustInterval": return A2(updateGustGen,
           function (gen) {
              return _U.update(gen,{interval: _p6._0});
           },
           course);
         case "SetGustAngle": return A2(function (_p7) {
              return updateGustGen(updateGustDefs(_p7));
           },
           A2($CoreExtra.updateAt,
           _p6._0,
           function (def) {
              return _U.update(def,{angle: $Basics.toFloat(_p6._1)});
           }),
           course);
         case "SetGustSpeed": return A2(function (_p8) {
              return updateGustGen(updateGustDefs(_p8));
           },
           A2($CoreExtra.updateAt,
           _p6._0,
           function (def) {
              return _U.update(def,{speed: $Basics.toFloat(_p6._1)});
           }),
           course);
         case "SetGustRadius": return A2(function (_p9) {
              return updateGustGen(updateGustDefs(_p9));
           },
           A2($CoreExtra.updateAt,
           _p6._0,
           function (def) {
              return _U.update(def,{radius: $Basics.toFloat(_p6._1)});
           }),
           course);
         case "CreateGustDef": return A2(function (_p10) {
              return updateGustGen(updateGustDefs(_p10));
           },
           function (defs) {
              return A2($List._op["::"],A3($Models.GustDef,0,0,200),defs);
           },
           course);
         case "RemoveGustDef": return A2(function (_p11) {
              return updateGustGen(updateGustDefs(_p11));
           },
...
Elm.AppUpdates.make = function (_elm) {
   ...
   var needsTransition = F2(function (before,after) {
      if (_U.eq(before,after)) return false; else {
            ...
            if (_p14.ctor === "_Tuple2" && _p14._0.ctor === "Just" && _p14._0._0.ctor === "Admin" && _p14._1.ctor === "Just" && _p14._1._0.ctor === "Admin")
            {
                  return false;
               } else {
                  return true;
   ...
   var update = F2(function (appAction,_p15) {
      ...
      {case "SetPath": return A2($AppTypes._op["&!"],
         ...
         case "PathChanged": var _p19 = _p17._0;
           ...
           var newCtx = _U.update(_p28,{transitStatus: $AppTypes.Exit});
           var newAppState = _U.update(_p27,{path: _p19,ctx: newCtx});
           return A2($AppTypes._op["&:"],newAppState,fx);
         case "MountRoute": var _p21 = _p17._0;
           var newCtx = _U.update(_p28,{transitStatus: $AppTypes.Enter});
           var newAppState = _U.update(_p27,{route: _p21,ctx: newCtx});
           var _p20 = newAppState.route;
           if (_p20.ctor === "Just") {
                 return A2(needsTransition,_p27.route,_p21) ? A2(mountRoute,
                 newAppState,
                 _p20._0) : A2($AppTypes._op["&:"],newAppState,$Effects.none);
              } else {
         ...
         case "SetPlayer": var fx = A2($Effects.map,
           ...
           var newCtx = _U.update(_p28,{player: _p17._0});
           return A2($AppTypes._op["&:"],_U.update(_p27,{ctx: newCtx}),fx);
         case "UpdateDims": return A2($AppTypes._op["&:"],
           _U.update(_p27,{ctx: _U.update(_p28,{dims: _p17._0})}),
           $Effects.none);
         case "MouseEvent": var handlerMaybe = function () {
              ...
              _v9_2: do {
                 if (_p23.ctor === "Just") {
                       switch (_p23._0.ctor)
                       {case "EditTrack": return $Maybe.Just(function (_p24) {
                               return $AppTypes.EditTrackAction($Screens$EditTrack$Updates.mouseAction(_p24));
                            });
                          case "ShowTrack": return $Maybe.Just(function (_p25) {
                               return $AppTypes.ShowTrackAction($Screens$ShowTrack$Updates.mouseAction(_p25));
                            });
                          default: break _v9_2;}
                    } else {
                       break _v9_2;
           ...
           var _p26 = handlerMaybe;
           if (_p26.ctor === "Just") {
                 return A2(updateScreen,_p26._0(_p17._0),_p27);
              } else {
                 return A2($AppTypes._op["&:"],_p27,$Effects.none);
              }
         case "Logout": return A2($AppTypes._op["&!"],_p27,logoutTask);
         case "ScreenAction": return A2(updateScreen,_p17._0,_p27);
         default: return A2($AppTypes._op["&:"],_p27,$Effects.none);}
   });
...
Elm.Screens.EditTrack.SideView.make = function (_elm) {
   ...
   var nameInput = function (n) {
      return $Screens$Utils.textInput(_U.list([$Html$Attributes.value(n)
                                              ,A2($Screens$Utils.onInput,
                                              $Screens$EditTrack$Updates.addr,
                                              $Screens$EditTrack$Types.SetName)
                                              ,$Html$Attributes.type$("text")]));
   };
   var gustDefRow = F2(function (i,def) {
      return A2($Html.tr,
      _U.list([]),
      _U.list([A2($Html.td,
              _U.list([]),
              ...
              ,A2($Html.td,
              _U.list([$Html$Attributes.$class("action")]),
              _U.list([A2($Html.a,
              _U.list([A2($Html$Events.onClick,
              $Screens$EditTrack$Updates.addr,
   ...
   _U.list([]),
   _U.list([A2($Html.th,_U.list([]),_U.list([$Html.text("angle")]))
           ,A2($Html.th,_U.list([]),_U.list([$Html.text("speed")]))
           ,A2($Html.th,_U.list([]),_U.list([$Html.text("radius")]))
           ,A2($Html.th,
           _U.list([$Html$Attributes.$class("action")]),
           _U.list([A2($Html.a,
           _U.list([A2($Html$Events.onClick,
   ...
   var gustDefsTable = function (defs) {
      ...
      _U.list([$Html$Attributes.$class("table-gust-defs")]),
      A2($List._op["::"],
      gustDefsHeader,
      A2($List.indexedMap,gustDefRow,defs)));
   };
