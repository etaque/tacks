      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 _v4._0,
                 _v4._1,
                 _L.fromArray([$Graphics$Collage.group(_L.fromArray([playerForms
                                                                    ,helpers]))]));
...
Elm.Tut.Steps.make = function (_elm) {
   ...
   state) {
      return function () {
         return function () {
            var stepTime = state.stepTime + _v0.delta;
