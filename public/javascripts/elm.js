...
Elm.Chat.Main.make = function (_elm) {
   ...
   var serverInput = Elm.Native.Port.make(_elm).inboundSignal("serverInput",
   "Json.Decode.Value",
   function (v) {
      return v;
   });
   var updates = $Signal.mergeMany(_L.fromArray([$Chat$Views.localUpdates.signal
                                                ,A2($Signal.map,
                                                handleServerInput,
                                                serverInput)]));
   var localOutput = Elm.Native.Port.make(_elm).outboundSignal("localOutput",
   function (v) {
      return v;
   },
   function () {
      var output = $Signal.mergeMany(_L.fromArray([A3($Signal.filter,
                                                  isOutputAction,
                                                  $Chat$Model.NoOp,
                                                  updates)
                                                  ,A2($Signal.map,
   ...
   var scrollDown = Elm.Native.Port.make(_elm).outboundSignal("scrollDown",
   function (v) {
      return [];
   },
   function () {
...
Elm.Chat.Views.make = function (_elm) {
   ...
   var localUpdates = $Signal.mailbox($Chat$Model.NoOp);
   ...
   field) {
      ...
      _L.fromArray([$Html$Attributes.type$("text")
                   ...
                   function (s) {
                      ...
                      $Chat$Model.UpdateStatusField(s));
                   })
                   ,A2(onEnter,
                   localUpdates.address,
   ...
   field) {
      ...
      _L.fromArray([$Html$Attributes.type$("text")
                   ...
                   function (msg) {
                      return A2($Signal.message,
                      localUpdates.address,
                      $Chat$Model.UpdateMessageField(msg));
                   })
                   ,A2(onEnter,
                   localUpdates.address,
...
Elm.Game.make = function (_elm) {
   ...
   var RaceCourse = {ctor: "RaceCourse"};
   ...
   var areaBottom = function (_v20) {
      return function () {
         return $Basics.snd(_v20.leftBottom);
      }();
   };
   var areaTop = function (_v22) {
      return function () {
         return $Basics.snd(_v22.rightTop);
      }();
   };
   var areaDims = function (_v24) {
      return function () {
         return function () {
            var $ = _v24.leftBottom,
            l = $._0,
...
Elm.LiveCenter.Main.make = function (_elm) {
   "use strict";
   _elm.LiveCenter = _elm.LiveCenter || {};
   _elm.LiveCenter.Main = _elm.LiveCenter.Main || {};
   if (_elm.LiveCenter.Main.values)
   return _elm.LiveCenter.Main.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $LiveCenter$Views = Elm.LiveCenter.Views.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Messages = Elm.Messages.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   ...
   var translator = $Messages.translator($Messages.fromJson(messagesStore));
   var main = A2($Signal.map,
   $LiveCenter$Views.mainView(translator),
   state);
   _elm.LiveCenter.Main.values = {_op: _op
                                 ,main: main
                                 ,translator: translator
                                 ,state: state
                                 ,updates: updates};
...
Elm.LiveCenter = Elm.LiveCenter || {};
Elm.LiveCenter.State = Elm.LiveCenter.State || {};
Elm.LiveCenter.State.make = function (_elm) {
   "use strict";
   _elm.LiveCenter = _elm.LiveCenter || {};
   _elm.LiveCenter.State = _elm.LiveCenter.State || {};
   if (_elm.LiveCenter.State.values)
   return _elm.LiveCenter.State.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "LiveCenter.State",
   $Basics = Elm.Basics.make(_elm),
   $Game = Elm.Game.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   _elm.LiveCenter.State.values = {_op: _op
                                  ,State: State
...
Elm.LiveCenter = Elm.LiveCenter || {};
Elm.LiveCenter.Update = Elm.LiveCenter.Update || {};
Elm.LiveCenter.Update.make = function (_elm) {
   "use strict";
   _elm.LiveCenter = _elm.LiveCenter || {};
   _elm.LiveCenter.Update = _elm.LiveCenter.Update || {};
   if (_elm.LiveCenter.Update.values)
   ...
   var ShowCourse = function (a) {
      return {ctor: "ShowCourse"
             ,_0: a};
   };
   var ServerUpdate = function (a) {
...
Elm.LiveCenter = Elm.LiveCenter || {};
Elm.LiveCenter.Views = Elm.LiveCenter.Views || {};
Elm.LiveCenter.Views.make = function (_elm) {
   "use strict";
   _elm.LiveCenter = _elm.LiveCenter || {};
   _elm.LiveCenter.Views = _elm.LiveCenter.Views || {};
   if (_elm.LiveCenter.Views.values)
   ...
   function (_v0) {
      return function () {
         ...
         {case "_Tuple2": return {_: {}
                                 ...
                                 ,time: _v0._0};}
         _U.badCase($moduleName,
         "on line 19, column 31 to 61");
      }();
   },
   $Time.timestamp($Time.fps(30)));
   var gameSetup = Elm.Native.Port.make(_elm).inbound("gameSetup",
   "Game.GameSetup",
   function (v) {
      return typeof v === "object" && "now" in v && "creationTime" in v && "countdown" in v && "course" in v && "player" in v && "gameMode" in v ? {_: {}
                                                                                                                                                   ...
                                                                                                                                                   v.player)
                                                                                                                                                   ,gameMode: typeof v.gameMode === "string" || typeof v.gameMode === "object" && v.gameMode instanceof String ? v.gameMode : _U.badPort("a string",
                                                                                                                                                   v.gameMode)} : _U.badPort("an object with fields `now`, `creationTime`, `countdown`, `course`, `player`, `gameMode`",
      v);
   });
...
Elm.Render.Dashboard.make = function (_elm) {
         ...
         return function () {
            ...
            {case "Just":
               return function () {
                    ...
                    0,
                    $List.head(_v26.playerState.crossedGates)) : _v28._0 - _v26.now;
            ...
            {case "_Tuple2":
               switch (_v37._0.ctor)
                 {case "Just":
                    switch (_v37._1.ctor)
                      {case "Just":
                         return $Maybe.Just(_v37._0._0 - _v37._1._0);}
                      break;}
                 break;}
            return $Maybe.Nothing;
         }() : $Maybe.Nothing;
   ...
   var getLeaderboard = function (_v42) {
      return function () {
         return function () {
...
Elm.Steps.make = function (_elm) {
   ...
   gust) {
      return function () {
         ...
         var radius = A2($Basics.min,
         (clock - gust.spawnedAt) * 1.0e-3 * gust.maxRadius / maxRadiusAfterSeconds,
         gust.maxRadius);
   ...
   _v17) {
      return function () {
         return function () {
            var _v19 = _v17.gameMode;
            switch (_v19.ctor)
            {case "TimeTrial":
               return function () {
                    var wind = spawnGust(_v17);
   ...
   var stepGame = F2(function (_v20,
   gameState) {
      return function () {
         return centerStep(A2(playerStep,
         _v20.keyboardInput,
         _v20.clock.delta)(updateWindStep(_v20.clock.delta)(A3(raceInputStep,
         _v20.raceInput,
         _v20.clock,
         gameState))));
      }();
