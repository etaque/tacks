...
Elm.Tut.Main.make = function (_elm) {
   ...
   var PlayerLeft = function (a) {
      return {ctor: "PlayerLeft"
             ,_0: a};
   };
   var PlayerJoin = function (a) {
      return {ctor: "PlayerJoin"
             ,_0: a};
   };
   var NoOp = {ctor: "NoOp"};
