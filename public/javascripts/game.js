...
Elm.Main.make = function (_elm) {
   ...
   Native.Ports.incomingSignal(function (v) {
      return typeof v === "object" && "now" in v && "startTime" in v && "course" in v && "player" in v && "wind" in v && "opponents" in v && "buoys" in v && "leaderboard" in v && "triggeredSpells" in v && "isMaster" in v ? {_: {}
                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                               ,player: v.player === null ? Maybe.Nothing : Maybe.Just(typeof v.player === "object" && "position" in v.player && "heading" in v.player && "velocity" in v.player && "windAngle" in v.player && "windOrigin" in v.player && "windSpeed" in v.player && "downwindVmg" in v.player && "upwindVmg" in v.player && "controlMode" in v.player && "tackTarget" in v.player && "crossedGates" in v.player && "nextGate" in v.player && "ownSpell" in v.player ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ,ownSpell: v.player.ownSpell === null ? Maybe.Nothing : Maybe.Just(typeof v.player.ownSpell === "object" && "kind" in v.player.ownSpell ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ,kind: typeof v.player.ownSpell.kind === "string" || typeof v.player.ownSpell.kind === "object" && v.player.ownSpell.kind instanceof String ? v.player.ownSpell.kind : _E.raise("invalid input, expecting JSString but got " + v.player.ownSpell.kind)} : _E.raise("invalid input, expecting JSObject [\"kind\"] but got " + v.player.ownSpell))} : _E.raise("invalid input, expecting JSObject [\"position\",\"heading\",\"velocity\",\"windAngle\",\"windOrigin\",\"windSpeed\",\"downwindVmg\",\"upwindVmg\",\"controlMode\",\"tackTarget\",\"crossedGates\",\"nextGate\",\"ownSpell\"] but got " + v.player))
                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                               ,opponents: _U.isJSArray(v.opponents) ? _L.fromArray(v.opponents.map(function (v) {
                                                                                                                                                                                                                                  return typeof v === "object" && "position" in v && "heading" in v && "velocity" in v && "name" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                        ,position: _U.isJSArray(v.position) ? {ctor: "_Tuple2"
                                                                                                                                                                                                                                                                                                                                                                              ,_0: typeof v.position[0] === "number" ? v.position[0] : _E.raise("invalid input, expecting JSNumber but got " + v.position[0])
                                                                                                                                                                                                                                                                                                                                                                              ,_1: typeof v.position[1] === "number" ? v.position[1] : _E.raise("invalid input, expecting JSNumber but got " + v.position[1])} : _E.raise("invalid input, expecting JSArray but got " + v.position)
                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                        ,name: typeof v.name === "string" || typeof v.name === "object" && v.name instanceof String ? v.name : _E.raise("invalid input, expecting JSString but got " + v.name)} : _E.raise("invalid input, expecting JSObject [\"position\",\"heading\",\"velocity\",\"name\"] but got " + v);
...
Elm.Steps.make = function (_elm) {
   ...
   var mouseStep = F2(function (_v18,
   _v19) {
      return function () {
         return function () {
            return function () {
   ...
   gameState) {
      return mouseStep(input.mouseInput)(A2(raceInputStep,
      input.raceInput,
      gameState));
   });
...
Elm.Render.Race.make = function (_elm) {
   ...
   var renderPlayerAngles = function (player) {
      return function () {
         ...
         "FixedWindAngle") ? Text.line(Text.Under) : Basics.id)(Render.Utils.baseText(_L.append(String.show(Basics.abs(Basics.round(player.windAngle))),
         "&deg;")))))));
   ...
   spells) {
      return function () {
         var wake = renderWake(_L.fromArray([]));
   ...
   dims) {
      return function () {
         return function () {
            ...
            Maybe.Just("Upwind")) ? A4(renderGateHint,
            _v29.course.upwind,
            dims,
            _v29.player.center,
            _v29.now) : Maybe.Nothing;
            var downwindHint = _U.eq(_v29.player.nextGate,
            Maybe.Just("Downwind")) ? A4(renderGateHint,
                      ...
                      return function () {
                           ...
                           {case "_Tuple2":
                              return _U.cmp(_v4._0,
                                _v5._1._0) > 0 && (_U.cmp(_v4._0,
                                _v5._0._0) < 0 && (_U.cmp(_v4._1,
                                _v5._1._1) > 0 && _U.cmp(_v4._1,
                                _v5._0._1) < 0));}
                           _E.Case($moduleName,
