...
Elm.ShiftMaster.make = function (_elm) {
   ...
   Native.Ports.incomingSignal(function (v) {
      return typeof v === "object" && "now" in v && "startTime" in v && "course" in v && "opponents" in v && "buoys" in v && "playerSpell" in v && "triggeredSpells" in v && "leaderboard" in v && "gusts" in v ? {_: {}
                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                  ,gusts: _U.isJSArray(v.gusts) ? _L.fromArray(v.gusts.map(function (v) {
                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                  })) : _E.raise("invalid input, expecting JSArray but got " + v.gusts)} : _E.raise("invalid input, expecting JSObject [\"now\",\"startTime\",\"course\",\"opponents\",\"buoys\",\"playerSpell\",\"triggeredSpells\",\"leaderboard\",\"gusts\"] but got " + v);
   }));
...
Elm.Steps.make = function (_elm) {
   ...
   var windStep = F4(function (delta,
   now,
   gusts,
   _v2) {
      return function () {
   ...
   gameState) {
      ...
      input.raceInput.now,
      input.delta,
      input.windowInput)(keysStep(input.keyboardInput)(A3(windStep,
      input.delta,
      input.raceInput.now,
      input.raceInput.gusts)(A2(raceInputStep,
      input.raceInput,
      gameState)))));
   });
...
Elm.Render.Controls.make = function (_elm) {
   ...
   var getArrow = _L.fromArray([{ctor: "_Tuple2"
                               ...
                               ,{ctor: "_Tuple2"
                                ,_0: -3
                                ,_1: -1}]);
   var getSpellStockGraphic = function (_v4) {
      return function () {
         switch (_v4)
         {case "PoleInversion":
            return function () {
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 return Graphics.Collage.move({ctor: "_Tuple2"
                                              ,_0: _v6._0 / 2 - 45
                                              ,_1: _v6._1 / 2 - 250})(Graphics.Collage.group(_L.fromArray([spellLabel
                                                                                                          ,outlineSquare
                                                                                                          ,spellGraphics])));
              }();}
         _E.Case($moduleName,
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 return Graphics.Collage.alpha(0.8)(Graphics.Collage.move({ctor: "_Tuple2"
                                                                          ,_0: _v10._0 / 2 - 50
                                                                          ,_1: _v10._1 / 2 - 120})(Graphics.Collage.group(_L.fromArray([c
                                                                                                                                       ,playerWindMarker
                                                                                                                                       ,playerMarker
                                                                                                                                       ,windOriginText]))));
              }();}
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 return Graphics.Collage.move({ctor: "_Tuple2"
                                              ,_0: (0 - _v14._0) / 2 + 20
                                              ,_1: _v14._1 / 2 - maxSpeed - 20})(Graphics.Collage.group(_L.fromArray([yAxis
                                                                                                                     ,xAxis
                                                                                                                     ,polar
                                                                                                                     ,playerProjection
                                                                                                                     ,playerMark
   ...
   var renderLapsCount = F3(function (_v18,
   course,
   player) {
      return function () {
         switch (_v18.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 return Graphics.Collage.move({ctor: "_Tuple2"
                                              ,_0: _v18._0 / 2 - 50
                                              ,_1: _v18._1 / 2 - 30})(Graphics.Collage.toForm(Text.rightAligned(Render.Utils.baseText(msg))));
              }();}
         _E.Case($moduleName,
                 ...
                 {case "_Tuple2":
                    return function () {
                         var distance = function (isOver) {
                            return Graphics.Collage.toForm(Text.centered(Render.Utils.baseText(String.show(Basics.round(Basics.abs(gate.y + (isOver ? 0 - _v22._1 : _v22._1) / 2 - _v23._1))))));
                         };
                         var markStyle = isNext ? Graphics.Collage.filled(Color.orange) : Graphics.Collage.filled(Color.white);
                         var c = 5;
                         var over = _U.cmp(_v23._1 + _v22._1 / 2 + c,
                         gate.y) < 0;
                         var under = _U.cmp(_v23._1 - _v22._1 / 2 - c,
                         gate.y) > 0;
                         var $ = Game.getGateMarks(gate),
                         left = $._0,
                         right = $._1;
                               ...
                               switch (_v30._0)
                                 {case true: return function () {
                                         var d = Graphics.Collage.move({ctor: "_Tuple2"
                                                                       ,_0: 0 - _v23._0
                                                                       ,_1: _v22._1 / 2 - c * 3})(distance(true));
                                         var m = Graphics.Collage.move({ctor: "_Tuple2"
                                                                       ,_0: 0 - _v23._0
                                                                       ,_1: _v22._1 / 2})(markStyle(Graphics.Collage.polygon(_L.fromArray([{ctor: "_Tuple2"
                                                                                                                                           ,_0: 0
                                                                                                                                           ,_1: 0}
                                                                                                                                          ,{ctor: "_Tuple2"
                                                                                                                                           ,_0: 0 - c
                                 ...
                                 {case true: return function () {
                                         var d = Graphics.Collage.move({ctor: "_Tuple2"
                                                                       ,_0: 0 - _v23._0
                                                                       ,_1: (0 - _v22._1) / 2 + c * 3})(distance(false));
                                         var m = Graphics.Collage.move({ctor: "_Tuple2"
                                                                       ,_0: 0 - _v23._0
                                                                       ,_1: (0 - _v22._1) / 2})(markStyle(Graphics.Collage.polygon(_L.fromArray([{ctor: "_Tuple2"
                                                                                                                                                 ,_0: 0
                                                                                                                                                 ,_1: 0}
                                                                                                                                                ,{ctor: "_Tuple2"
                                                                                                                                                 ,_0: 0 - c
   ...
   var renderAbsolute = F2(function (_v33,
   dims) {
      return function () {
         return function () {
            var justForms = _L.fromArray([A3(renderLapsCount,
                                         ...
                                         _v33.player,
                                         dims)]);
            var nextGate = _U.cmp(_v33.countdown,
            0) < 1 ? A2(Game.findNextGate,
            _v33.player,
            _v33.course.laps) : Maybe.Nothing;
...
Elm.Inputs.make = function (_elm) {
   ...
   Keyboard.space,
   Keyboard.shift,
   Keyboard.isDown(Char.toCode(_U.chr("A"))));
