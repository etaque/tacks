...
Elm.Main.make = function (_elm) {
   ...
   $Native$Ports.incomingSignal(function (v) {
      return typeof v === "object" && "now" in v && "startTime" in v && "course" in v && "playerState" in v && "wind" in v && "opponents" in v && "leaderboard" in v && "isMaster" in v ? {_: {}
