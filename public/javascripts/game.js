...
Elm.Main.make = function (_elm) {
   ...
   $Native$Ports.incomingSignal(function (v) {
      return typeof v === "object" && "playerId" in v && "now" in v && "startTime" in v && "course" in v && "playerState" in v && "wind" in v && "opponents" in v && "ghosts" in v && "leaderboard" in v && "isMaster" in v && "watching" in v ? {_: {}
                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                 ,watching: typeof v.watching === "boolean" ? v.watching : _E.raise("invalid input, expecting JSBoolean but got " + v.watching)} : _E.raise("invalid input, expecting JSObject [\"playerId\",\"now\",\"startTime\",\"course\",\"playerState\",\"wind\",\"opponents\",\"ghosts\",\"leaderboard\",\"isMaster\",\"watching\"] but got " + v);
   }));
            ...
            var mainPlayer = function () {
               ...
               {case "Just":
                  return A3($Maybe.maybe,
                    ...
                    renderPlayer(_v14.course.windShadowLength),
                    _v14.playerState);
                  case "Nothing":
                  return function () {
