      ...
      return typeof v === "object" && "playerId" in v && "now" in v && "startTime" in v && "course" in v && "playerState" in v && "wind" in v && "opponents" in v && "leaderboard" in v && "isMaster" in v && "watching" in v ? {_: {}
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                ,opponents: _U.isJSArray(v.opponents) ? _L.fromArray(v.opponents.map(function (v) {
                                                                                                                                                                                                                                   return typeof v === "object" && "player" in v && "position" in v && "heading" in v && "velocity" in v && "vmgValue" in v && "windAngle" in v && "windOrigin" in v && "windSpeed" in v && "downwindVmg" in v && "upwindVmg" in v && "trail" in v && "controlMode" in v && "tackTarget" in v && "crossedGates" in v && "nextGate" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ,nextGate: v.nextGate === null ? $Maybe.Nothing : $Maybe.Just(typeof v.nextGate === "string" || typeof v.nextGate === "object" && v.nextGate instanceof String ? v.nextGate : _E.raise("invalid input, expecting JSString but got " + v.nextGate))} : _E.raise("invalid input, expecting JSObject [\"player\",\"position\",\"heading\",\"velocity\",\"vmgValue\",\"windAngle\",\"windOrigin\",\"windSpeed\",\"downwindVmg\",\"upwindVmg\",\"trail\",\"controlMode\",\"tackTarget\",\"crossedGates\",\"nextGate\"] but got " + v);
...
Elm.Render.Players.make = function (_elm) {
   ...
   var renderWake = function (wake) {
      return function () {
         ...
         var renderSegment = function (_v0) {
            return function () {
               switch (_v0.ctor)
               {case "_Tuple2":
                  switch (_v0._1.ctor)
                    {case "_Tuple2":
                       return $Graphics$Collage.alpha(opacityForIndex(_v0._0))($Graphics$Collage.traced(style)(A2($Graphics$Collage.segment,
                         _v0._1._0,
                         _v0._1._1)));}
                    break;}
               _E.Case($moduleName,
   ...
   var renderEqualityLine = F2(function (_v6,
   windOrigin) {
      return function () {
         switch (_v6.ctor)
         {case "_Tuple2":
      ...
      return function () {
         return function () {
            var filteredOpponents = function () {
               var _v12 = _v10.watchMode;
               switch (_v12.ctor)
               {case "NotWatching":
                  return _v10.opponents;
                  case "Watching":
