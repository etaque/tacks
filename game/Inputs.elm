...
type RaceInput = { now: Time, startTime: Time, course: Maybe Game.Course, opponents: [Game.Opponent], playerSpell: Maybe Game.Spell, triggeredSpells: [Game.Spell], leaderboard: [String] }
